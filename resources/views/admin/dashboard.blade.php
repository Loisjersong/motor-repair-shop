            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Total Apppointments</span>
                    </div>
    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-6 2xl:px-10">
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="px-4 py-6 md:px-6 xl:px-7.5">
                <h4 class="text-xl font-bold text-black dark:text-white">New Products</h4>
            </div>
            ...
            @foreach ($products as $product)
                <div class="grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
                    ...
                    <div class="col-span-1 flex items-center">
                        <p class="text-sm font-medium text-black dark:text-white">{{ $product->brand }}</p>
                    </div>
                    <div class="col-span-1 flex items-center">
                        <p class="text-sm font-medium text-black dark:text-white">{{ $product->in_stock }}</p>
                    </div>
                    <div class="col-span-1 flex items-center">
                        <p class="text-sm font-medium text-meta-3">${{ number_format($product->price, 2) }}</p>
                    </div>
                </div>
            @endforeach
        </div>
